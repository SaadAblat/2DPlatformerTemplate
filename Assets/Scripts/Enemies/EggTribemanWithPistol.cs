...
public class EggTribemanWithPistol : Enemy
{
    Rigidbody2D rb;
    ...
    [SerializeField] float RangeDistanceX;
    [SerializeField] float RangeDistanceY;
    ...
    [SerializeField] EnemyWeapon pistol;
    bool isTakingDamage;
    ...
    void Start()
    {
        OCParent = obstacleCheckStart.parent;
    ...
    private void ChangeDirection()
    {
        ...
        OCParent.localScale = new Vector3(transform.localScale.x * -1, transform.localScale.y * 1, transform.localScale.z * 1);
    ...
    private bool PlayerInRange()
    {
        if (playerTransform != null)
        {
            if (Mathf.Abs(playerTransform.position.x - transform.position.x) < RangeDistanceX
                      && Mathf.Abs(playerTransform.position.y - transform.position.y) < RangeDistanceY
                      && (playerTransform.position.y - transform.position.y) > targetMinHeight)
